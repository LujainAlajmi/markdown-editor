...
export default function Sidebar() {
  ...
  return (
    <aside className="flex min-h-screen w-[250px] flex-col justify-between bg-[#1D1F22] px-6 py-8">
      <div>
        ...
        <div className="space-y-7">
          <Typography type="heading-small" className="text-[#7C8187]">
            MY DOCUMENTS
          </Typography>
          ...
          <div className=" space-y-6">
            {data?.user?.documents?.map((document: Document) => (
              ...
              >
                ...
                <div className="">
                  <>
                    <Typography type="body" className=" p-0 text-[#7C8187]">
                      {/* format date to 01 April 2022*/}

                      {new Date(document?.createdAt).toUTCString().slice(5, 16)}
                    </Typography>
                    <Link href={`/document/${document.id}`}>
                      <Typography
                        type="heading-medium"
                        className=" text-white hover:text-[#E46643] "
                      >
                        {document?.title}
                      </Typography>
                    </Link>
